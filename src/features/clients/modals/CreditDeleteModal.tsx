...
import { useDeleteClientCredit, useResolveCreditDeletion } from '@/features/clients/api/clientCreditQueries';
    ...
    <BaseModal isOpen={true} onClose={closeModal} title={t('credits.deleteCredit')}>
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-text-primary text-sm">{t('credits.deleteCreditConfirmation', { description: credit.description })}</p>
          ...
          <div className="rounded-lg border border-status-warning-border bg-status-warning-bg p-4 space-y-3">
            <div className="flex gap-3">
              ...
              <div className="space-y-2">
                ...
                <p className="text-status-warning-text text-sm">{t('credits.cannotDeleteWithAllocations')}</p>
