...
import { useAddEmployeeBorrow } from '@/features/employees/api/employeeQueries';
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <label htmlFor="borrow-amount" className="font-semibold text-text-primary text-sm block">
        ...
        <div className="space-y-2">
          <label htmlFor="borrow-notes" className="font-semibold text-text-primary text-sm block">
            ملاحظات
          </label>
          <textarea
