...
import { useAddEmployeePayout } from '@/features/employees/api/employeeQueries';
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <label htmlFor="payout-amount" className="font-semibold text-text-primary text-sm block">
        ...
        <div className="space-y-2">
          <label htmlFor="payout-type" className="font-semibold text-text-primary text-sm block">
        ...
        <div className="space-y-2">
          <label htmlFor="payout-notes" className="font-semibold text-text-primary text-sm block">
            ملاحظات
          </label>
          <textarea
