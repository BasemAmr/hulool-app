...
import { useGetEmployeeClientsInfinite } from '@/features/employees/api/employeeClientsQueries';
  ...
  return (
    <div className="w-full p-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          <h1 className="text-xl font-bold mb-1 text-text-primary">عملائي</h1>
          ...
          <div className="p-0">
            ...
            {!isLoading && clients.length === 0 && (
              <div className="text-center p-5">
                <h5 className="text-text-primary mb-2 font-bold">لا يوجد عملاء</h5>
