...
import type { EmployeeCredit } from '@/features/employees/api/employeeFinancialQueries';
  ...
  return (
    <div className="w-full overflow-x-auto" dir="rtl">
      ...
      <table className="w-full">
        <thead className={`bg-status-info-bg0 text-white ${isSticky ? 'is-sticky' : ''}`}>
        ...
        <tbody>
          {credits.map((credit) => {
            ...
            return (
              ...
              >
                ...
                <td className="text-center py-3 px-2">
                  <span className="text-text-primary">{credit.client_phone || '—'}</span>
                </td>
                <td className="text-center py-3 px-2">
                ...
                <td className="text-center py-3 px-2">
                  <span className={`font-bold ${isFullyAllocated ? 'text-status-success-text' : 'text-status-danger-text'}`}>
                    {formatCurrency(remainingAmount)} ر.س
                  </span>
                </td>
                <td className="text-center py-3 px-2">
                  <span className="text-text-primary" style={{ fontSize: '0.85em' }}>
          ...
          <tr style={{
            ...
            <td className="text-center font-bold">
              <span className={totalRemaining > 0 ? 'text-status-danger-text' : 'text-status-success-text'}>
