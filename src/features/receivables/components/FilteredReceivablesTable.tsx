            ...
            return (
              <React.Fragment key={receivable.id}>
                <TableRow className="hover:bg-bg-surface-hover transition-colors">
                  ...
                  <TableCell>
                    <div className="text-text-primary text-sm flex justify-center items-center">
                        <button
                          className="p-0 text-status-success-text hover:text-status-success-text transition-colors ml-1"
                          onClick={() => handleWhatsApp(receivable.client?.phone || '')}
                          title="WhatsApp"
                        >
                          <MessageSquare size={12} />
                        </button>
                        <span className="text-text-primary">{receivable.client?.phone}</span>
                      </div>
                  </TableCell>
                  <TableCell className="text-center">
                  ...
                  <TableCell className="text-center font-bold text-status-danger-text">
                    {formatCurrency(receivable.amount)}
                  </TableCell>
                  <TableCell className="text-center font-bold text-status-success-text">
                  ...
                  <TableCell className="text-center">
                    <small className={new Date(receivable.due_date) < new Date() ? 'text-status-danger-text font-bold' : 'text-text-primary'}>
                      ...
                      <div className="bg-muted/30 p-3 rounded-lg">
                        ...
                        <div className="w-full overflow-x-auto">
                          <div className="grid grid-cols-5 gap-2 divide-y divide-border">
                            {/* Header */}
                            <div className="col-span-5 grid grid-cols-5 gap-2 bg-muted/50 p-2 rounded font-bold text-text-primary text-sm">
                            ...
                            {receivable.payments.map((payment) => (
                              <div key={payment.id} className="col-span-5 grid grid-cols-5 gap-2 p-2 hover:bg-muted/20 transition-colors">
                                <div className="text-center font-bold text-status-success-text">
