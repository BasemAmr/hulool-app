...
import { useDeleteReceivable, useDeleteReceivableWithResolution } from '@/features/receivables/api/receivableQueries';
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-status-warning-border bg-status-warning-bg p-4 flex gap-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-status-warning-text text-sm">{t('receivables.deleteReceivableWarning', { 
        ...
        {conflictData && (
          <div className="rounded-lg border border-status-warning-border bg-status-warning-bg p-4 space-y-3">
            <div className="space-y-2">
              ...
              <p className="text-status-warning-text text-sm">{t('receivables.cannotDeleteWithPayments')}</p>
