...
import { useUpdateReceivable, useResolveReceivableOverpayment, useAutoResolveReceivableOverpayment } from '@/features/receivables/api/receivableQueries';
...
import AmountDetailsInput from '@/shared/ui/primitives/AmountDetailsInput';
      ...
      {conflictData ? (
        ...
        <div className="p-4 space-y-4">
          <div className="rounded-lg border border-status-warning-border bg-status-warning-bg p-4">
            ...
            <p className="text-status-warning-text text-sm mb-0">
          ...
          {/* Resolution Options */}
          <div>
            <h6 className="flex items-center gap-2 font-semibold text-text-primary mb-3">
          ...
          {selectedResolution === 'manual_resolution' && (
            <div className="border border-border rounded-lg p-3 space-y-4">
              <h6 className="font-semibold text-text-primary mb-3">Manual Resolution Details</h6>
                ...
                <div>
                  ...
                  {conflictData.payments.map((payment) => (
                    <div key={payment.id} className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mb-3 p-3 border border-border rounded-lg">
                      <div>
                        <div className="font-semibold text-text-primary">{payment.amount} SAR</div>
                ...
                <div>
                  ...
                  {conflictData.allocations.map((allocation) => (
                    <div key={allocation.id} className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center mb-3 p-3 border border-border rounded-lg">
                      <div>
                        <div className="font-semibold text-text-primary">{allocation.amount} SAR</div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="p-4 space-y-4">
            ...
            <div className="rounded-lg border border-blue-600 bg-status-info-bg p-4">
              <div className="flex items-start gap-2">
                <i className="bi bi-info-circle text-status-info-text"></i>
                <div className="text-sm text-blue-800">
                  ...
                  {isTiedToTask && (
                    <>
                      ...
                      <br />
                      <small className="text-status-info-text">{t('receivables.tiedToTaskNotice')}</small>
                    </>
                  )}
                </div>
              </div>
            ...
            {/* Type Field */}
            <div>
              <label className="font-semibold text-text-primary text-sm block mb-2">{t('receivables.chooseType')}</label>
              <select
                className="w-full px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
