...
import { useCreateInvoice } from '@/features/invoices/api/invoiceQueries';
              ...
              <div className="text-center">
                ...
                <div className="client-card selected mx-auto" style={{ maxWidth: '300px' }}>
                  ...
                  <div className="selected-indicator">
                    <span className="text-status-success-text text-xl">✓</span>
                  </div>
                </div>
                <Button
                  variant="primary"
          ...
          <div>
            ...
            <div className="mb-4 p-3 bg-bg-surface-muted rounded-lg">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm text-text-muted">العميل</label>
                  <div className="mt-1">
            ...
            <div className="bg-primary/10 p-4 rounded-lg mb-4 text-center">
              <div className="text-sm text-text-secondary mb-1">إجمالي الفاتورة</div>
