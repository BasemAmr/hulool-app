...
import { useUpdateInvoice, useValidateInvoiceEdit } from '@/features/invoices/api/invoiceQueries';
    ...
    >
      <div className="space-y-4 dir-rtl" dir="rtl">
        ...
        {invoice?.paid_amount > 0 && (
          <div className="bg-status-warning-bg border border-status-warning-border p-3 rounded-md text-sm">
            <p className="font-medium text-status-warning-text">⚠️ تحذير</p>
            <p className="text-status-warning-text mt-1">
