            ...
            {data?.original && (
              <div className="bg-bg-surface-muted rounded-lg p-3 text-sm space-y-2">
                ...
                {renderEntityLink(data.original) && (
                  <div className="flex items-center gap-2">
                    <span className="text-text-secondary">مرتبط بـ:</span>
                    {renderEntityLink(data.original)}
                  </div>
                )}
              </div>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr className="hover:bg-bg-surface-muted">
                      <td className="px-3 py-2 border border-border-strong">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="text-sm">
                            ...
                            <div className="text-xs text-text-muted">ID: {data.original.id}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-3 py-2 border border-border-strong">
                      ...
                      <td className="px-3 py-2 border border-border-strong text-start">
                        {data.original.credit && parseFloat(data.original.credit) > 0 ? (
                          <span className="text-status-info-text font-semibold flex items-center gap-1">
                  ...
                  {data?.related ? (
                      ...
                      <td className="px-3 py-2 border border-border-strong">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="text-sm">
                            ...
                            <div className="text-xs text-text-muted">ID: {data.related.id}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-3 py-2 border border-border-strong">
                    ...
                    <tr className="bg-status-warning-bg">
                      <td colSpan={5} className="px-3 py-2 border border-border-strong text-center text-sm text-status-warning-text">
                ...
                <tfoot className="bg-bg-surface-muted font-semibold text-sm">
                  <tr>
                    ...
                    <td className="px-3 py-2 text-start text-status-success-text border border-border-strong">
                      {formatCurrency(
                        (parseFloat(data?.original?.debit || 0) +
                          parseFloat(data?.related?.debit || 0))
                      )}
                    </td>
                    <td className="px-3 py-2 text-start text-status-info-text border border-border-strong">
                      {formatCurrency(
                        (parseFloat(data?.original?.credit || 0) +
                          parseFloat(data?.related?.credit || 0))
                      )}
                    </td>
                    <td className="px-3 py-2 border border-border-strong"></td>
                  </tr>
                </tfoot>
              </table>
            </div>
