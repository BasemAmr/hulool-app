  ...
  return (
    ...
    >
      <div className="modal-content-wrapper space-y-4">
        {/* Instructions */}
        <div className="rounded-lg border border-blue-600 bg-status-info-bg p-4 flex gap-3">
          <Layers size={18} className="text-status-info-text flex-shrink-0 mt-0.5" />
          <div>
            <div className="font-semibold text-text-primary mb-1">إدارة المهام الفرعية</div>
            ...
            >
              <div className="grid grid-cols-5 gap-4 items-start">
                ...
                <div className="col-span-2">
                  <label className="font-medium text-text-primary text-sm block mb-2">وصف المهمة الفرعية</label>
                  <Input
                ...
                <div className="col-span-1">
                  <label className="font-medium text-text-primary text-sm block mb-2">المبلغ (ريال)</label>
                  <NumberInput
                ...
                {/* Completion Status */}
                <div className="col-span-1">
                  <label className="font-medium text-text-primary text-sm block mb-2">مكتملة</label>
                  <div className="flex items-center gap-2">
                    ...
                    <label className="cursor-pointer text-sm" htmlFor={`completed-${index}`}>
                      {subtask.is_completed ? (
                        <span className="text-status-success-text flex items-center gap-1">
                          <Check size={14} />
                          مكتملة
                        </span>
                      ) : (
