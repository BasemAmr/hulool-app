...
import { useCompleteTask } from '@/features/tasks/api/taskQueries';
...
const TaskCompletionModal = () => {
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-blue-600 bg-status-info-bg p-3 flex flex-col gap-2 mb-4">
