    ...
    return (
        ...
        >
            <div className="space-y-4" dir="rtl">
                <div className="bg-status-warning-bg border border-status-warning-border rounded-md p-4">
                    <div className="flex">
                        ...
                        <div className="mr-3">
                            ...
                            <div className="mt-2 text-sm text-status-warning-text">
                                <p>
                ...
                <div className="space-y-3">
                    {consequences.invoices_to_delete.length > 0 && (
                        <div className="bg-status-danger-bg p-3 rounded-md border border-red-100">
                            <h4 className="font-bold text-status-danger-text text-sm mb-2">الفواتير التي سيتم حذفها:</h4>
                            <ul className="list-disc list-inside text-sm text-status-danger-text space-y-1">
                                {consequences.invoices_to_delete.map((inv) => (
                                    <li key={inv.invoice_id}>
                                        فاتورة #{inv.invoice_id} - {inv.description}
                                        ({inv.amount} ريال)
                                        {inv.has_payments && (
                                            <span className="block mr-5 text-sm font-bold text-status-danger-text">
                    ...
                    {consequences.commission_to_delete && (
                        <div className="bg-status-danger-bg p-3 rounded-md border border-red-100">
                            <h4 className="font-bold text-status-danger-text text-sm mb-2">العمولات التي سيتم إلغاؤها:</h4>
