...
import { useValidateTaskEdit, useUpdateTaskAmount, useUpdateTaskPrepaid } from '@/features/tasks/api/taskQueries';
import { useToast } from '@/shared/hooks/useToast';
import { TOAST_MESSAGES } from '@/shared/constants/toastMessages';
import ValidationPreviewModal from '@/features/tasks/modals/ValidationPreviewModal';
  ...
  return (
    ...
    >
      <div className="space-y-4 dir-rtl" dir="rtl">
        ...
        {/* Calculated Summary */}
        <div className="bg-status-info-bg p-3 rounded-md text-sm space-y-1">
          ...
          <div className="flex justify-between border-t border-status-info-border pt-1">
        ...
        {newPrepaid > newAmount && (
          <div className="bg-status-danger-bg border border-status-danger-border p-3 rounded-md text-sm text-status-danger-text">
