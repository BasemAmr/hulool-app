...
import { useCancelTask } from '@/features/tasks/api/taskQueries';
    ...
    <div className="analysis-summary bg-orange-50 p-4 rounded-lg mb-6 border border-orange-200">
      ...
      <div className="space-y-2 text-sm text-text-secondary">
        ...
        {analysisData.prepaid_receivable && (
          <div className="mt-3 p-3 bg-status-info-bg rounded border border-status-info-border">
        ...
        {analysisData.main_receivable && (
          <div className="mt-3 p-3 bg-status-success-bg rounded border border-status-success-border">
            <p className="font-semibold text-status-success-text mb-1">القيمة الأساسية:</p>
        ...
        <div className="mt-4 p-3 bg-status-warning-bg rounded border border-status-warning-border">
            ...
            <div key={payment.id} className="payment-item border p-4 rounded-lg mb-3 bg-background">
              ...
              <div className="decision-options space-y-2">
                ...
                <label className="flex cursor-pointer items-center rounded p-2 transition-colors hover:bg-background">
                  ...
                  />
                  <div>
                    <span className="font-medium text-status-danger-text">حذف الدفعة</span>
                ...
                <label className="flex cursor-pointer items-center rounded p-2 transition-colors hover:bg-background">
                  ...
                  />
                  <div>
                    <span className="font-medium text-status-success-text">تحويل إلى رصيد</span>
                    <p className="text-sm text-text-secondary">سيتم تحويل المبلغ إلى رصيد للعميل</p>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div key={allocation.id} className="allocation-item border p-4 rounded-lg mb-3 bg-background">
              ...
              <div className="decision-options space-y-2">
                ...
                <label className="flex cursor-pointer items-center rounded p-2 transition-colors hover:bg-background">
                  ...
                  />
                  <div>
                    <span className="font-medium text-status-info-text">إرجاع إلى الرصيد</span>
                ...
                <label className="flex cursor-pointer items-center rounded p-2 transition-colors hover:bg-background">
                  ...
                  />
                  <div>
                    <span className="font-medium text-status-danger-text">حذف التخصيص</span>
                    <p className="text-sm text-text-secondary">سيتم حذف سجل التخصيص نهائياً</p>
                  </div>
                </label>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center p-3 border rounded-lg hover:bg-background cursor-pointer border-status-danger-border">
              <input 
                ...
                onChange={(e) => setTaskAction(e.target.value as 'cancel' | 'delete')}
                className="mr-3 text-status-danger-text"
              />
              <div className="flex-1">
                <span className="font-semibold text-status-danger-text">حذف المهمة نهائياً</span>
                <p className="text-sm text-text-secondary mt-1">
