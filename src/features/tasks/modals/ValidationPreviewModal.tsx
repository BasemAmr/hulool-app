  ...
  return (
    ...
    >
      <div className="space-y-6 dir-rtl" dir="rtl">
          ...
          <div className="bg-status-warning-bg border-2 border-status-warning-border rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-base text-status-warning-text">
        ...
        {/* Errors */}
        {hasErrors && (
          <div className="bg-status-danger-bg border-2 border-status-danger-border rounded-lg p-4">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 text-status-danger-text mt-1">
                <AlertCircle size={24} />
              </div>
              <div>
              ...
              <table className="w-full border-collapse border border-border-strong bg-card">
                <thead className="bg-background">
                  <tr>
                    ...
                    <th className="border border-border-strong px-3 py-2 text-right font-bold">المبلغ الجديد</th>
                  </tr>
                </thead>
                <tbody>
                  {(cons.transaction_changes || cons.transactions_affected || []).map((change: any, i: number) => (
                    <tr key={i}>
                      ...
                      <td className="border border-border-strong px-3 py-2 text-sm font-bold">
            ...
            <div className="space-y-4">
              {cons.commissions_affected.map((comm: any, i: number) => (
                <div key={i} className="rounded-lg border border-status-success-border bg-card p-4 shadow-sm">
                  ...
                  <div className="mt-3 flex items-center justify-between text-base font-bold text-status-success-text">
              ...
              <table className="w-full border-collapse border border-border-strong bg-card">
                <thead className="bg-background">
                  <tr>
                    ...
                    <th className="border border-border-strong px-3 py-2 text-center text-base font-bold">الرصيد المتوقع</th>
                    <th className="border border-border-strong px-3 py-2 text-center text-base font-bold">التغيير</th>
                  </tr>
                </thead>
                <tbody>
