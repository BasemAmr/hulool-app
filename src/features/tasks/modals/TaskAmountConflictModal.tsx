...
import { useResolveTaskAmountChange } from '@/features/tasks/api/taskQueries';
...
const TaskAmountConflictModal: React.FC<TaskAmountConflictModalProps> = ({
  ...
  const renderConflictSummary = () => (
    <div className="rounded-lg border border-destructive bg-destructive/10 p-4 space-y-3">
      ...
      <div className="p-3 rounded-lg border border-status-warning-border bg-status-warning-bg">
  ...
  const renderPaymentDecisions = () => (
    <div className="space-y-3">
      <h3 className="text-lg font-semibold text-text-primary">{t('tasks.mainReceivablePaymentDecisions')}</h3>
  ...
  const renderAllocationDecisions = () => (
    <div className="space-y-3">
      <h3 className="text-lg font-semibold text-text-primary">{t('tasks.mainReceivableAllocationDecisions')}</h3>
