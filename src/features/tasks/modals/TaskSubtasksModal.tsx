...
import { useUpdateTask } from '@/features/tasks/api/taskQueries';
  ...
  return (
    ...
    >
      <div className="max-h-screen overflow-y-auto space-y-4">
        ...
        {hasValidSubtasks && (
          <div className="bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg border border-border-strong p-4 space-y-3">
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-right">
                ...
                {hasSubtasks() && !shouldDisableAmount() && (
                  <small className="text-status-info-text text-xs mt-1 block">
