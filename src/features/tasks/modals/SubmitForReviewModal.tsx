...
const SubmitForReviewModal = () => {
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-blue-600 bg-status-info-bg p-3 flex flex-col gap-2">
      ...
      <div className="rounded-lg border border-status-warning-border bg-status-warning-bg p-3 flex flex-col gap-2">
        <h6 className="font-semibold text-status-warning-text text-sm">{t('tasks.submitForReviewModal.title')}</h6>
        <p className="text-status-warning-text text-sm mb-2">{t('tasks.submitForReviewModal.taskWillBeSubmitted', { taskName: task.task_name || `#${task.id}` })}</p>
        <p className="text-status-warning-text text-sm mb-0">{t('tasks.submitForReviewModal.askAboutPayment')}</p>
      </div>
        ...
        {watchIsPaid ? (
          ...
          <div className="space-y-4 pl-6 border-l-2 border-primary">
            ...
            <div className="space-y-2">
              <label className="font-semibold text-text-primary text-sm block">{t('payments.methodLabel')}</label>
              <Controller
