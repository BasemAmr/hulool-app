...
import { type TaskMessage, type TaskMessagePaginatedData } from '@/features/tasks/api/taskMessageQueries';
...
const MessageList: React.FC<MessageListProps> = ({
    ...
    return (
      <div className="flex items-center justify-center h-full p-4">
        <div className="text-center">
          ...
          <p className="text-sm text-text-primary mb-0">جاري تحميل التعليقات...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex items-center justify-center h-full p-4">
        <div className="text-center">
          <AlertCircle className="text-status-danger-text mb-3" size={32} />
          <h6 className="text-text-primary mb-1 font-semibold">خطأ في تحميل التعليقات</h6>
  ...
  if (allMessages.length === 0) {
    return (
      <div className="flex items-center justify-center h-full p-4">
        <div className="text-center">
          <MessageSquare className="text-text-primary mb-3" size={48} />
          <h6 className="text-text-primary mb-1 font-semibold">لا توجد تعليقات بعد</h6>
          <p className="text-sm text-text-primary mb-0">
    ...
    <div ref={ref} className="flex mb-2">
      ...
      <div className="flex-1 min-w-0">
        <div className="bg-muted rounded p-2">
          ...
          <p className="text-sm mb-0 text-text-primary" style={{ lineHeight: '1.3' }}>
