...
import { useCreateTaskMessage } from '@/features/tasks/api/taskMessageQueries';
        ...
        <div className="flex">
          <div className="flex-1 mr-2">
            <textarea
              ...
              className="w-full px-3 py-2 text-sm border border-input rounded-md bg-background text-text-primary focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-colors disabled:opacity-50"
              rows={1}
