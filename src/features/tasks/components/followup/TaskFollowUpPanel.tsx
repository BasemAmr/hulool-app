...
import { useTaskMessages } from '@/features/tasks/api/taskMessageQueries';
        ...
        <div className="border-b border-border bg-muted/30 px-4 py-3">
          <div className="flex items-center">
            ...
            <div className="flex-1 min-w-0">
              <h5 className="text-lg font-bold text-text-primary mb-0">المتابعة والتعليقات</h5>
            ...
            <button 
              type="button" 
              className="text-text-primary hover:text-foreground transition-colors p-2"
              onClick={handleClose}
              aria-label="Close"
            >
