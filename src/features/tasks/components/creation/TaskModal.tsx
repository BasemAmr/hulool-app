...
import { playNotificationSound } from '@/shared/utils/soundUtils';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
            ...
            {(step === 2 || isEditMode) && (
              <div className="step-content main-form fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3">
                  <div>
                    <label className="font-semibold text-text-primary text-sm block mb-1">نوع مهمة</label>
                    <Controller
                      name="type"
                      control={control}
                      rules={{ required: true }}
                  ...
                  <div>
                    <label className="font-semibold text-text-primary text-sm block mb-1">اسم العميل</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3">
                  ...
                  <div>
                    <label className="font-semibold text-text-primary text-sm block mb-1">التاريخ الإنشاء</label>
                    <Controller
                      name="start_date"
                      control={control}
                      rules={{ required: true }}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="text-right">
                        <div className="flex flex-col items-end">
                          ...
                          <small className="text-status-success-text font-semibold text-sm">
                ...
                <Accordion type="single" collapsible className="mb-3">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      {/* Prepaid Amount */}
                      <div className="mb-3">
                        <label className="font-semibold text-text-primary text-sm block mb-1">المدفوع مقدماً</label>
                        <Controller
                          name="prepaid_amount"
                          control={control}
                          rules={{
                      ...
                      {/* End Date (moved here) */}
                      <div className="mb-3">
                        <label className="font-semibold text-text-primary text-sm block mb-1">تاريخ الانتهاء</label>
                        <Controller
                          name="end_date"
                          control={control}
                          render={({ field }) => (
                      ...
                      <div className="requirements-section">
                        <div className="flex justify-between items-center mb-2">
                          <label className="font-semibold text-text-primary text-sm mb-0">المتطلبات</label>
                          <Button
                            type="button"
