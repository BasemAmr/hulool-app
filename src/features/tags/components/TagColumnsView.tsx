...
import type { TagColumnsViewProps } from '@/features/tags/types/tagTypes';
        ...
        return (
            <div className="text-center py-5">
                <div className="empty-icon mb-3">
                    <i className="fas fa-tags fa-4x text-text-muted"></i>
                </div>
                <h5 className="text-text-primary mb-2 font-semibold">لا توجد علامات مُضافة</h5>
                <p className="text-text-primary">قم بإضافة علامات لتنظيم المهام وعرضها في أعمدة منفصلة</p>
            </div>
        );
    }
