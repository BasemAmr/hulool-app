...
import { useUpdateMyProfile, useSetMyPassword } from '../../queries/userQueries';
        ...
        <div className="min-h-screen p-6">
            <div className="mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <h1 className="text-3xl font-bold text-black">إعدادات الموظف</h1>
                </div>
            </div>
                ...
                <div className="rounded-lg border bg-card p-6">
                    ...
                    <form onSubmit={handlePasswordChange} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                type="password"
                                className={`base-input ${passwordError ? 'border-red-500' : ''}`}
