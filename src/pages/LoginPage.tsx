...
import { useRequestPasswordReset, useConfirmPasswordReset } from '../queries/userQueries';
                  ...
                  {resetStep === 'request' ? (
                    ...
                    <>
                      ...
                      <form onSubmit={handleConfirmReset}>
                        ...
                        <button
                          type="submit"
                          className="px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-semibold w-full hover:bg-green-700 transition-colors disabled:opacity-50"
                          disabled={confirmResetMutation.isPending}
                        >
