    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          disabled={disabled}
        >
          <span className={cn(!selectedClient && 'text-text-primary/50')}>
          ...
          <CommandList>
            {isLoading ? (
              <div className="py-6 text-center">
                <Loader2 className="mx-auto h-4 w-4 animate-spin text-text-primary/50" />
                <p className="mt-2 text-xs text-text-primary/50">جاري البحث...</p>
              </div>
