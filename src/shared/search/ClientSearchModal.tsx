...
import { useSearchClients } from '@/features/clients/api/clientQueries';
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      className="w-9 h-9 flex items-center justify-center rounded-full border border-status-success-border text-status-success-text hover:bg-status-success-bg hover:scale-110 transition-all duration-200"
