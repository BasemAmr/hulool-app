...
import { useGetUnreadNotificationCount } from '@/features/notifications/api/notificationQueries';
import { playNotificationSound, preloadNotificationSound } from '@/shared/utils/soundUtils';
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span 
            className="absolute -top-0.5 -right-0.5 bg-status-danger-bg0 text-white rounded-full flex items-center justify-center text-[10px] min-w-[18px] h-[18px] animate-pulse"
          >
        ...
        {error && (
          <span 
            className="absolute -top-0.5 -right-0.5 bg-status-danger-bg0 rounded-full w-3 h-3"
