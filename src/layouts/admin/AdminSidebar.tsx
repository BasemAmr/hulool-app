  ...
  return (
    <>
      ...
      <nav className="flex-1 py-2 overflow-y-auto scrollbar-thin scrollbar-thumb-muted-foreground scrollbar-track-transparent hover:scrollbar-thumb-primary">
        <div className="mb-4">
          <div className="text-xs text-text-secondary font-bold uppercase tracking-wider px-2 mb-1 text-right">القائمة الرئيسية</div>
        ...
        <div className="mb-4">
          <div 
            className="text-xs text-text-secondary font-bold uppercase tracking-wider px-2 mb-1 text-right cursor-pointer flex items-center justify-between"
        ...
        <div className="mb-4">
          <div className="text-xs text-text-secondary font-bold uppercase tracking-wider px-2 mb-1 text-right">المركز المالي</div>
        ...
        <div className="mb-4">
          <div className="text-xs text-text-secondary font-bold uppercase tracking-wider px-2 mb-1 text-right">إدارة المهام</div>
        ...
        <div className="mx-2 mb-2 relative">
          ...
          />
          <Search size={16} className="absolute right-2 top-1/2 -translate-y-1/2 text-text-muted transition-all duration-200 pointer-events-none" />
        </div>
      </nav>
      ...
      <div className="p-2 border-t border-border bg-muted/30">
        <div className="flex items-center gap-2 p-1.5 bg-muted/50 rounded-lg transition-all duration-200 hover:bg-muted/70">
          ...
          <button
            ...
            className="bg-transparent border-none text-text-secondary text-base cursor-pointer p-1.5 rounded transition-all duration-200 flex-shrink-0 hover:text-status-danger-text hover:bg-status-danger-bg hover:scale-105 active:scale-95"
